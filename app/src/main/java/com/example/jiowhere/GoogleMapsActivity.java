...
public class GoogleMapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityNameTextView = (TextView) findViewById(R.id.activityNameTitle);

//        activityName = getIntent().getStringExtra("activityNameTextView");
//        activityNameTextView.setText(activityName);
        activityNameTextView.setText("1600 Amphitheatre Parkway, Mountain View, CA");

        //new GetCoordinates().execute(activityNameTextView.getText().toString().replace(" ","+"));
